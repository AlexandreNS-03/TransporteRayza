 ...
 * La rueda del sorteo.
 *
 * Los sectores llevan los nombres de quienes participan de verdad, y la aguja
 * frena sobre el del ganador. Eso es lo que la hace creíble: una rueda de
 * colores que se detiene en cualquier parte y después anuncia un nombre no
 * demuestra nada.
 *
 * Sigue sin decidir nada. El ganador viene del servidor; acá solo se calcula
 * cuánto hay que girar para que su sector quede debajo de la aguja.
 *
 * Cuando hay mucha gente no caben todos: la rueda muestra una parte y lo dice.
 * El ganador siempre se pinta, aunque no estuviera en esa muestra.
 */
      ...
      <div className="ruleta-disco">
        <div className="ruleta-aguja" aria-hidden="true">
          <svg viewBox="0 0 24 34" width="26" height="36">
            <path d="M12 33 L3 13 A9 9 0 1 1 21 13 Z" fill="var(--ruleta-aguja)" />
            <circle cx="12" cy="10" r="3.4" fill="var(--card)" />
          </svg>
        </div>
