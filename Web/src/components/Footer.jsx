        ...
        <div className="cols">
          <div>
            ...
            <ul className="footer-contacto">
              ...
              <li><a href={`mailto:${EMPRESA.correo}`}>{EMPRESA.correo}</a></li>
              {EMPRESA.oficinas.map((o) => (
                <li key={o.ciudad}>
                  <b>{o.ciudad}{o.central ? " (central)" : ""}:</b>{" "}
                  {o.puntos.map((pt) => `${pt.direccion} (${pt.tipo.toLowerCase()})`).join(" · ")}
                </li>
              ))}
            </ul>
            <div className="social">
              <a href={EMPRESA.redes.facebook} target="_blank" rel="noopener" aria-label="Facebook">
              ...
              <a href={EMPRESA.redes.instagram} target="_blank" rel="noopener" aria-label="Instagram">
